# TASK-218 — Task Breakdown

## Implementation steps
1. Define immutable dataclasses / enums for `FullRegression` with non-empty id guards.
...
## Status
All steps complete; tests green for `regression.py`.
