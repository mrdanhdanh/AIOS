# TASK-198 — Task Breakdown

## Implementation steps
1. Define immutable dataclasses / enums for `CodingEditionStateMachine` with non-empty id guards.
...
## Status
All steps complete; tests green for `state_machine.py`.
