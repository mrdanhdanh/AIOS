...
Usage / Cost / Audit / Evidence lives in:

- `aios/model_runtime/usage.py` — `UsageCollector, UsageRecord, AuditLog, CostCompute, AuditEntry`.
- Tests trong `aios/model_runtime/tests/test_model_runtime.py` (Test Matrix TASK-115).
