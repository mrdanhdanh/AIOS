...
Context Harness + Conformance lives in:

- `aios/context/conformance.py` — `ContextHarness, ContextConformance, ConformanceResult, ConformanceStage`.
- Tests trong `aios/context/tests/test_context.py` (Test Matrix TASK-124).
