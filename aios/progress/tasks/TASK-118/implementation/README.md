...
Source / Symbol Index lives in:

- `aios/context/symbol_index.py` — `SymbolIndex, SymbolIndexResult, Symbol`.
- Tests trong `aios/context/tests/test_context.py` (Test Matrix TASK-118).
