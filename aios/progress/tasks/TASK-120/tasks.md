...
1. `aios/context/hybrid_index.py` — `HybridIndex, HybridIndexResult, HybridQueryResult, Embedding`.
...
5. Tích hợp dependency: T118/T119 -> T120 -> T121.
6. Tests (6) theo Test Matrix TASK-120.
