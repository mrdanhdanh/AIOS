...
- Dependency closure: T001..T116 (M17) + TASK-120 (M18). Chạy `python -m pytest aios -q`.
- Thêm `aios/context/hybrid_index.py` + tests trong `aios/context/tests/test_context.py`.
