# TASK-207 — Task Breakdown

## Implementation steps
1. Define immutable dataclasses / enums for `SessionFork` with non-empty id guards.
...
## Status
All steps complete; tests green for `session_fork.py`.
