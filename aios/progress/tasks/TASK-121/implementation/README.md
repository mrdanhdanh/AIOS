# TASK-121 Implementation

Context Retriever lives in:

- `aios/context/retriever.py` — `ContextRetriever, RetrievalResult, RetrievalHit`.
- Tests trong `aios/context/tests/test_context.py` (Test Matrix TASK-121).
