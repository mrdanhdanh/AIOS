...
Context Verification + Evidence lives in:

- `aios/context/verification.py` — `ContextVerification, VerificationResult, VerificationVerdict`.
- Tests trong `aios/context/tests/test_context.py` (Test Matrix TASK-123).
