...
- Dependency closure: T001..T116 (M17) + TASK-123 (M18). Chạy `python -m pytest aios -q`.
- Thêm `aios/context/verification.py` + tests trong `aios/context/tests/test_context.py`.
