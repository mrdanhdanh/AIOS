...
1. `aios/model_runtime/model_registry.py` — `ModelRegistry, ModelResolver, ResolveStatus`.
...
5. Tích hợp dependency: T109 -> T111 -> T112/T116.
6. Tests (6) theo Test Matrix TASK-111.
