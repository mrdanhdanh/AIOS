...
- Dependency closure: T001..T113 (toàn M0-M16). Chạy `python -m pytest aios -q`.
- Thêm `aios/model_runtime/orchestration.py` + tests trong `aios/model_runtime/tests/test_model_runtime.py`.
