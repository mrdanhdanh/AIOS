# TASK-122 Implementation

Context Builder + Budget lives in:

- `aios/context/builder.py` — `ContextBuilder, BuiltContext, BuiltChunk`.
- Tests trong `aios/context/tests/test_context.py` (Test Matrix TASK-122).
