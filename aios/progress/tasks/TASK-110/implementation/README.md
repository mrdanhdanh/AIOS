...
Provider Registry + Lifecycle lives in:

- `aios/model_runtime/provider_registry.py` — `ProviderRegistry, ProviderRecord, LifecycleEvent, ProviderStatus, HealthStatus`.
- Tests trong `aios/model_runtime/tests/test_model_runtime.py` (Test Matrix TASK-110).
