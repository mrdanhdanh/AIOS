...
Repository Scanner lives in:

- `aios/context/scanner.py` — `RepositoryScanner, ScanResult, ScannedFile, ChangeSet, ScanError`.
- Tests trong `aios/context/tests/test_context.py` (Test Matrix TASK-117).
