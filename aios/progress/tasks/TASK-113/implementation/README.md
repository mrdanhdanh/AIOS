# TASK-113 Implementation

Credential + Permission + Policy Integration lives in:

- `aios/model_runtime/security.py` — `SecurityGate, SecurityContext, CredentialBoundary, PermissionCheck, PolicyPrecheck`.
- Tests trong `aios/model_runtime/tests/test_model_runtime.py` (Test Matrix TASK-113).
