...
## Scope
**In scope:** `aios/skill/github_bridge/` — `parser.py`, `adapter.py`, `converter.py`, `__init__.py`, `tests/test_bridge.py`. Tích hợp Skill (T015) + Plugin Runtime (T044) + Architecture Guard (T063) + Ecosystem Registry (T046) + Certification (T049).
