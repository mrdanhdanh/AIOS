...
- Dependency closure: T001..T116 (M17) + TASK-119 (M18). Chạy `python -m pytest aios -q`.
- Thêm `aios/context/dependency_graph.py` + tests trong `aios/context/tests/test_context.py`.
