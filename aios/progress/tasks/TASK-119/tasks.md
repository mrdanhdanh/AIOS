...
1. `aios/context/dependency_graph.py` — `DependencyGraph, DependencyGraphResult, DepNode, DepEdge`.
...
5. Tích hợp dependency: T117/T118 -> T119 -> T120.
6. Tests (6) theo Test Matrix TASK-119.
