# TASK-114 Implementation

Retry / Timeout / Streaming / Cancellation lives in:

- `aios/model_runtime/resilience.py` — `ResilienceManager, ResilienceConfig, CancellationToken, StreamChunk, ResilienceStatus`.
- Tests trong `aios/model_runtime/tests/test_model_runtime.py` (Test Matrix TASK-114).
